...
namespace LibMetadata.IO
{
    public class FlacFileInfo : IAudioFileInfo
    {
        ...
        public List<IFlacMetadataBlock> OtherBlocks { get; set; }
        ...
        public FlacFileInfo(string filePath) : this()
        {
            _filePath = filePath;
        }

        private void UpdateVorbisComments(string text)
        {
            VorbisCommentBlock.AddComment(text);
        }
    }
}
